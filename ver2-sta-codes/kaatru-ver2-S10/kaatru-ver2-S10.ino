// DEVICE - S10//change according to the device
#include "Arduino.h"
...
String DeviceID = String("S10"); //change according to the device
File myFile;
...
const int C1 = A0;
const int T1 = A2;
const float Sf1 = 32.95; //nA/ppm replace this value with your own sensitivity
float temp1;
float vGas;
float getConcen;
//float temp1;
...
void gprs_send(String val)
{
  ...
  SIM808.println("AT+HTTPDATA=255,7000\r\n");
  delay(1500);
  Serial.println(ReadGSM());
  delay(2000);
