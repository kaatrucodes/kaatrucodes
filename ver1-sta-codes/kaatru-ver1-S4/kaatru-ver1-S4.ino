// DEVICE - S4 //change according to the device
#include "Arduino.h"
...
String DeviceID = String("S4"); //change according to the device
File myFile;
...
const int C1 = A2;
const int T1 = A0;
const float Sf1 = 31.58; //nA/ppm replace this value with your own sensitivity
float temp1;
float vGas;
float getConcen;
float TZero;
