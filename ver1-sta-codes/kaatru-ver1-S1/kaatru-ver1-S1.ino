// DEVICE - S1 //change according to the device
#include "Arduino.h"
...
String DeviceID = String("S1"); //change according to the device
File myFile;
...
const int C1 = A2;
const int T1 = A0;
const float Sf1 = 28.94; //nA/ppm replace this value with your own sensitivity
float temp1;
float vGas;
float getConcen;
float TZero;
