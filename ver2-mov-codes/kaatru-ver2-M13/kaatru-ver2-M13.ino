...
String DeviceID = String("M13"); //change according to the device
File myFile;
...
const int C1 = A0;
const int T1 = A2;
const float Sf1 = 38.36; //nA/ppm replace this value with your own sensitivity
float temp1;
float vGas;
float getConcen;
float TZero;
...
void setup() {
  ...
  delay(5000);
  SIM808.begin(57600); // setting up SIM808
  initGps();
  //getRtctime();
  gprs_init();
  gprs_init_http();
