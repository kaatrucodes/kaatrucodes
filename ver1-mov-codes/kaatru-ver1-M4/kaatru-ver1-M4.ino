...
// DEVICE - M4//change according to the device
...
String DeviceID = String("M4"); //change according to the device
File myFile;
...
const int C1 = A2;
const int T1 = A0;
const float Sf1 = 25.15; //nA/ppm replace this value with your own sensitivity
float temp1;
float vGas;
float getConcen;
float TZero;
...
String getValuesDummy()  //uncomment to send dummy gps data
{
  ...
  //String fullvalue = (DeviceID + delimiter + DeviceID + delimiter + gpsDummy + getOutStr());
  return fullvalue;
}
